...
namespace Geopoiesis.UI
{
    public class UIList : UIBase
    {
        ...
        {
            lblTitle.Position = Position - new Point((int)(TitleFont.MeasureString(Title).X  / -2) ,(int)(TitleFont.LineSpacing*1.5f));
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            //_spriteBatch.Draw(t, Rectangle, new Color(1, 0, 0, .0125f));
            //_spriteBatch.End();
